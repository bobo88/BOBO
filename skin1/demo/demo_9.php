...
<head>
    ...
    <? include '../top.html'; ?>
    <style>
        .nav-bg-icon{ display: inline-block;*display: inline;*zoom: 1; background: url(images/demo_9/address/nav_bg.png) no-repeat;}
        .two11-address-wrap{ width: 100%; min-width: 1100px; background: #f9dc1f;}
        .two11-address-wrap .banner-box{ width: 100%; min-width: 1100px; height: 480px; background: url(images/demo_9/address/address_banner.jpg) top center no-repeat;}
        ...
        .coupon-list-wrap{ margin-bottom: 60px; width: 100%; min-width: 1100px; height: 160px; background: #fe457f;}
        .coupon-list-box{ margin: 0 auto; width: 1100px; height: 160px;}
        .coupon-list{ padding: 22px 0; width: 1110px; height: 116px;}
        .coupon-list li{ float: left; margin-right: 10px; width: 267px; height: 116px; background: url(images/demo_9/address/coupon_bg.png) top center no-repeat;}
        .coupon-content{}
        .coupon-content .coupon-num{ position: relative; z-index: 1; float: left; padding: 28px 10px 28px 15px; width: 80px; height: 60px; color: #fe457f; text-align: center;}
        ...
        .coupon-content .coupon-detail .detail-tit{ height: 16px; line-height: 16px; color: #fe457f; font-size: 12px; font-weight: bold;overflow: hidden; text-overflow: ellipsis; white-space: nowrap;}
        ...
        .coupon-content .coupon-detail .coupon-btn{ display: block; width: 120px; height: 20px; line-height: 20px; color: #fff; font-size: 14px; font-weight: bold; text-align: center; background: #fe457f; text-decoration: none;
        ...
        .address-tit{ margin-bottom: 60px; width: 100%; height: 60px; line-height: 60px; color: #fe457f; font-size: 38px; font-weight: bold; text-align: center; background: url(images/demo_9/address/address_tit_bg.png) center center no-repeat;}
        ...
        .goods-time{height:30px; color:#fef5d8;font-size:14px;background-color:#fe457f;text-align:center;}
        ...
        .process-inner{position:absolute;left:0;top:0;display:block;background: #fe457f;width:0%;height: 11px;-webkit-border-radius: 10px; -moz-border-radius: 10px; -ms-border-radius: 10px; border-radius: 10px;}
        .goods-limit-tips{
            position:absolute;left:0;top:-30px;width:95px; height:20px;font:normal 12px/20px Arial;
            background:#fff;border:1px solid #fe457f;text-align: center;-webkit-border-radius: 3px; -moz-border-radius: 3px; -ms-border-radius: 3px; border-radius: 3px;
        }
        .goods-limit-tips b{color:#fe457f;padding-right:5px;}
        .goods-limit-tips em{position:absolute;display:block;bottom:-10px;left:10px;border-width:5px;border-style:solid;}
        .goods-limit-tips em.tri_bd{border-color:#fe457f transparent transparent transparent;bottom:-11px;z-index:1;}
        ...
        .goods-buy a{
            display:inline-block;width:130px;height:24px;text-align:center;line-height:24px;background:#fe457f;text-transform:uppercase;
        ...
        .top-brands-box{ padding: 14px 12px; width: 1070px; border:3px solid #000; background: #fe457f;}
        ...
        .brands-nav li .maxza{ padding: 38px 8px; width: 80px; height: 19px; background: url(images/demo_9/address/maxza.png) center center no-repeat;}
        .brands-nav li .nexbox{ padding: 42px 3px; width: 90px; height: 12px; background: url(images/demo_9/address/nexbox.png) center center no-repeat;}
        .brands-nav li .onda{ padding: 41px 8px; width: 80px; height: 13px; background: url(images/demo_9/address/onda.png) center center no-repeat;}
        .brands-nav li .beelink{ padding: 38px 2px; width: 92px; height: 19px; background: url(images/demo_9/address/beelink.png) center center no-repeat;}
        .brands-nav li .lmi{ padding: 36px 12px; width: 72px; height: 23px; background: url(images/demo_9/address/lmi.png) center center no-repeat;}
        ...
        .pro-list li .pro-detail{ position: relative; z-index: 1; padding: 10px; width: 194px; height: 100px; background: #fe457f;}
        ...
        .icon-cart{ display: inline-block;*display: inline;*zoom: 1; width: 24px; height: 24px; background: url(images/demo_9/address/icon_cart.png) center center no-repeat;}

        .hot-deals-sec{ margin: 0 auto 60px; width: 1100px;}
        .hot-deals-nav{ width: 1110px; height: 60px;}
        .hot-deals-nav li{ position: relative; z-index: 1; float: left; margin-right: 10px; width: 360px; height: 60px; line-height: 60px; text-align: center; background: #ed195c;
        ...
        .hot-deals-nav li.on{ top: -20px; width: 354px; height: 80px; background: #fe457f; border:3px solid #000000; border-bottom: none;}
        .hot-deals-nav li.on a{ height: 80px; line-height: 80px; color: #f9dc1f;}

        .hot-deals-pro-list{ padding: 30px; border: 3px solid #000000; background: #fe457f;
        ...
        .hot-deals-pro-list .pro-list li .shop-price{color: #fe457f;}
        .hot-deals-pro-list .pro-list li .pro-detail{ width: 184px; background: #fff;}
        .hot-deals-pro-list .pro-list li .buy-now{ width: 100px; color: #fff; background: #fe457f;}
        ...
        .promotion-footer{ width: 100%; min-width: 1100px; height: 200px; background: url(images/demo_9/address/coupon_bg_repeat.gif) repeat;}
        .foot-link-wrap{ padding-left: 200px;}
        .foot-link{ position: relative; z-index: 1; top: -60px; margin: 0 auto; width: 900px; height: 240px; background: url(images/demo_9/address/toys_foot_bg.png) left center no-repeat;}
        .foot-link a{ position: absolute; z-index: 2; top: 60px; display: block; padding-left: 300px; width: 600px; height: 200px;}
        .foot-link a strong{ height: 60px; line-height: 60px; display: block; color: #fe457f; font-size: 48px; font-weight: bold;}
        .foot-link a span{ color: #231b38; font-size: 24px; font-weight: bold;}
        ...
        .nav-fix-box ul li a{ display: block; width: 100%; height: 100%; color: #f9dc1f; font-size: 14px; text-decoration: none;}
        ...
        .nav-sort-wrap{ padding: 4px 0 12px;}
        .nav-topic{ width: 64px; height: 31px; background-position: 0 0;}
        .nav-sort{ width: 116px; height: 14px; background-position: -100px -30px;}
        ...
        .blank-line{ margin: 0 auto 60px; width: 1100px; height: 11px; background: url(images/demo_9/address/blank_line.png) center center no-repeat;}
        .foot-banner-wrap{ margin: 0 auto 60px; width: 1100px;}
        .foot-banner-wrap ul{ width: 1130px; height: 172px;}
        .foot-banner-wrap ul li{ float: left; margin-right: 30px; width: 252px; height: 172px;}
        .foot-banner-wrap ul li a,.foot-banner-wrap ul li img{ display: block; width: 252px; height: 172px;}
    </style>
</head>
<body>
    <header id="header">
    ...
    <div class="two11-address-wrap">
      ...
      <section class="flash-sale-sec js-floorTarget">
        <h3 class="address-tit">Flash Sale</h3>
      ...
      <section class="top-brands-sec js-floorTarget">
        <h3 class="address-tit">Top Brands</h3>
        ...
        <div class="top-brands-box radius-5">
          <div class="brands-pro-wrap">
            ...
            <div class="brands-pro-list radius-5 js-topBrandsTarget">
              <ul class="pro-list clearfix">
                <li>
                  <p class="pro-img"><a href="#" target="special"><img src="http://www.yuanbo88.com/demo/images/demo_1/demo_1_4.jpg" alt="服装会场"></a></p>
          ...
          <div class="tb-banner radius-5">
            <a href="#" target="special"><img src="images/demo_9/address/tb_banner.jpg" width="1070" height="250" alt="服装会场"></a>
          </div>
        </div>
      </section>
      ...
      <section class="hot-deals-sec js-floorTarget">
        <h3 class="address-tit">Hot Deals</h3>
      ...
      <div class="blank-line"></div>
        ...
        <div class="foot-banner-wrap">
            <ul class="clearfix">
                <li><a href="#" target="special"><img src="images/demo_9/address/foot_banner1.jpg" alt="服装会场"></a></li>
                <li><a href="#" target="special"><img src="images/demo_9/address/foot_banner2.jpg" alt="服装会场"></a></li>
                <li><a href="#" target="special"><img src="images/demo_9/address/foot_banner3.jpg" alt="服装会场"></a></li>
                <li><a href="#" target="special"><img src="images/demo_9/address/foot_banner4.jpg" alt="服装会场"></a></li>
            </ul>
        </div>
